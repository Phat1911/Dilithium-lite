...
- After each milestone, mark/comment at where that milestone is implemented and check the completed tasks in plan.md after each milestone, finally, push and commit the change onto github.